...
<template>
  <TransitionRoot as="template" :show="open">
    <Dialog as="div" class="relative z-40" @close="closeSignUpDialog">
      ...
      <div class="fixed inset-0 z-40 flex">
        <TransitionChild as="template" enter="transition ease-in-out duration-300 transform"
          ...
          <DialogPanel class="absolute left-1/2 -translate-x-1/2 top-10 z-40">
            <div class="relative flex flex-col rounded-2xl overflow-hidden sign-up-wrapper">
              <div class="absolute right-3 top-3" @click="closeSignUpDialog">
              ...
              <div id="main" class="p-6 md:p-8 bg-white">
                <div class="text-2xl md:text-4xl font-taviraj mb-8">Create an account</div>
                <BaseInput label="Username" placeholder="Username" class="mb-4" />
                <BaseInput label="E-mail" placeholder="E-mail" type="email" class="mb-4" />
                <BaseInput label="Password" placeholder="Password" type="password" class="mb-6" />
                <BaseButton text="Sign Up" color="secondary" size="large" class="w-full mb-4" />
